    ...
    <body>
        ...
        <nav class="navbar navbar-default navbar-trans navbar-expand-lg fixed-top">
            <div class="container">
                ...
                <div type="button" class="nav-item btn" style="padding:  0.35rem 1rem;">
            ...
            <div class="vh-100 d-flex justify-content-center align-items-center">
                <div class="card col-md-4 bg-white shadow-md p-5">
                    ...
                    <div class="text-center">
                        <h1>Welcome to us!</h1>
                        <p>Explore our meticulously curated rental properties, featuring a variety of homes, from urban apartments to countryside cottages, for an unforgettable stay</p>
