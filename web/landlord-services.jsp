                            ...
                            <div class="card mb-4">
                                <div class="card-body text-center">
                                    ...
                                    <ul class="list-group text-start">
                                        ...
                                        <li class="list-group-item"><span
                                                class="text-bg-warning">--Contact--</span><span>
                                                Go to the customer's personal page</span></li>
                                        <li class="list-group-item"><span
                                                class="text-bg-success">--Approve--</span><span>
                                                Customers can view your personal
                                                information</span></li>
                                        <li class="list-group-item"><span
                                                class="text-bg-danger">--Reject--</span><span>
                                                Customers can't see your contact
                                                information</span></li>
                                    </ul>
                                </div>
                            </div>
                                    ...
                                    <ul class="list-group list-group-flush rounded-3">
                                        <li class="list-group-item text-center">
                                            <a class="pe-none" href="#!">
                                                <button type="button" class=" w-100 btn btn-dark "> Manage rental requests</button>
                                            </a>
                                        </li>
                                        <li class="list-group-item">
                                            <div class="contain">
                                                <a
                                                    ...
                                                    <button type="button" class="btn btn-secondary">Pending requests</button>
                                                </a>
                                            </div>
                                        </li>
                                        <li class="list-group-item">
                                        ...
                                        <li class="list-group-item text-center">
                                            <a class="pe-none" href="#!"><button type="button"
                                                                                 class=" w-100 btn btn-dark "> Manage My Post</button>
                                            </a>
                                        </li>
                                        <li class="list-group-item">
                                            <div class="contain">
