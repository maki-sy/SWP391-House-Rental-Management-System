...
function Validator(options) {
    ...
    var mySelectType = document.getElementById("type");
    var mySelectCity = document.getElementById("location_id");

    var draftAction = document.getElementById("draft");
    var payAction = document.getElementById("pay");
    var action = false
    var typeValue
    var locationValue
    draftAction.onchange = () => {
        action = true;
        if (typeValue && locationValue && action) {
            isFormValid = true
        } else {
            isFormValid = false
        }
    ...
    mySelectType.onchange = () => {
        typeValue = mySelectType.options[mySelectType.selectedIndex].value;
    ...
    mySelectCity.onchange = () => {
        locationValue = mySelectCity.options[mySelectCity.selectedIndex].value;
        if (typeValue && locationValue && action) {
            isFormValid = true
        } else {
            isFormValid = false
