...
<html lang="en">
    ...
    <head>
        ...
        <title>Editing Post | RentalHouse</title>
                        ...
                        <div class="col">
                            <nav aria-label="breadcrumb" class="bg-light rounded-3 p-3 mb-4">
                                <ol class="breadcrumb mb-0">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Edit Posts And Draft</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                    ...
                    <div class="row">
                                ...
                                <div class="card-body text-center">
                                    ...
                                    <ul class="list-group text-start">
                                        <li class="text-start list-group-item active list-group-item-action"
                                            aria-current="true">Manage posts editable</li>
                                        ...
                                        <li class="list-group-item"><span
                                                ...
                                                See what your post will look like when you publish it</span></li>
                                        <li class="list-group-item"><span
                                                class="text-bg-warning">--Edit--</span><span>
                                                Edit post details</span></li>
                                        <li class="list-group-item"><span
                                                class="text-bg-danger">--Delete--</span>
                                            <span>
                                                Delete the post completely and you won't be able to recover the data</span></li>
                                    </ul>
                                </div>
                            </div>
                            <!-- SIDE BAR HERE -->
                        ...
                        <div class="card col-lg-8">
                            ...
                            <table class="table table-hover">
                                <thead>
                                    <tr>
                                        <th class="col-lg-auto" scope="col">#</th>
                                        <th class="col-lg-auto" scope="col">ID</th>
                                        <th class="col-lg-3" scope="col">Name</th>
                                        <th class="col-lg-auto" scope="col">Price</th>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="javascript:void(0);"
                                               onclick="confirmDelete(<%=post.getId()%>)">
                                                <button type="submit"
                        ...
                        <script src="assets/js/edit-posts.js"></script>
